...
variable "template_suffix" {
    type = string
    default = "k3s-nixos-24.11.20240921.9357f4f"
}

# Define variables for the VM configurations
variable "pvc_node_configs" {
  default = {
    "server-2" = { vm_id = 2003, cores = 4, ram = 4096, hard_drive = 50, macaddr = "42:69:CE:F4:12:AE", type="server" }
#    "agent-1" = { vm_id = 2011, cores = 4, ram = 4096, hard_drive = 50 , macaddr = "82:b0:13:fe:4d:32", type="agent"}
#    "agent-2"  = { vm_id = 2023, cores = 12, ram = 8096, hard_drive = 100, macaddr = "1a:9b:20:dc:d6:c8"}
  }
}
variable "pvd_node_configs" {
  default = {
    "server-3" = { vm_id = 2004, cores = 4, ram = 4096, hard_drive = 50, macaddr = "42:69:CE:F4:12:AE", type="server" }
    #"agent-3"  = { vm_id = 2022, cores = 4, ram = 4096, hard_drive = 100 , macaddr = "26:e4:6c:4e:01:1b"}
  }
}

variable "pve_node_configs" {
  default = {
#    "server-4" = { vm_id = 2005, cores = 4, ram = 4096, hard_drive = 50, macaddr = "be:0f:4d:3e:c6:03", type="server" }
    #"agent-4"  = { vm_id = 2021, cores = 4, ram = 4096, hard_drive = 100 , macaddr = "0a:03:1a:99:a7:c4"}
    #"agent-5"  = { vm_id = 2023, cores = 4, ram = 8096, hard_drive = 100, macaddr = "1a:9b:20:dc:d6:c8"}
  }
