...
variable "pvc_node_configs" {
  default = {
    ...
    "boris-3" = { vm_id = 2043, cores = 12, ram = 4096, hard_drive = 500 }
  }
}
variable "pvd_node_configs" {
  default = {
    ...
    "boris-2" = { vm_id = 2042, cores = 4, ram = 4096, hard_drive = 500 }
  }
}
...
variable "pve_node_configs" {
  default = {
    ...
    "boris-1" = { vm_id = 2041, cores = 4, ram = 4096, hard_drive = 500 }
  }
